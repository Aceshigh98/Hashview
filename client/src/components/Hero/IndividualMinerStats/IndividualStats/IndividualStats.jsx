  ...
  return (
    <div className={classes["stats"]}>
      ...
      <div className={classes["stats-inner"]}>
        ...
        <div className={classes["stats-inner-div"]}>
          <div className={classes["details"]}>
            <h3>{(miner.hashrate / hashDiv).toFixed(2) + " TH/S"}</h3>
            <p>Hashrate</p>
          </div>

          <div className={classes["icon"]}>
            <GiMining className={classes["icon-inner"]} />
          </div>
        </div>
        <div className={classes["stats-inner-div"]}>
          <div className={classes["details"]}>
        ...
        <div className={classes["stats-inner-div"]}>
          ...
          <div className={classes["icon"]}>
            {miner.status === "Active" ? (
              <GrStatusGood className={classes["icon-inner-active"]} />
            ) : (
              <GrStatusWarning className={classes["icon-inner-inactive"]} />
            )}
          </div>
        </div>
