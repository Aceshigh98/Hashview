...
const RING_PROPAGATION_SPEED = 9;
const aspect = 1.2;
const cameraZ = 300;
...
function Globe({ globeConfig, data }) {
  ...
  const defaultProps = {
    ...
    polygonColor: "rgba(240,186,51, 1)",
    arcTime: 2000,
    arcLength: 0.9,
    rings: 1,
    maxRings: 3,
...
function World(props) {
  ...
  return (
    <Canvas scene={scene} camera={new PerspectiveCamera(60, aspect, 180, 1500)}>
      <WebGLRendererConfig />
...
export { World, Globe, WebGLRendererConfig, genRandomNumbers, hexToRgb };
